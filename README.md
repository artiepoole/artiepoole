...
My hobby x86_32 operating system written in C-style C++. ArtOS is a from-scratch OS project capable of playing DOOM (1993) in userspace, loaded from CD-ROM using asynchronous DMA drivers. ABefore writing this, I knew basically nothing about operating systems (e.g. I had no idea what a kernel was, or what user-space meant).
